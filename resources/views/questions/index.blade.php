    ...
    @if ($isSuperadmin && blank($selectedBidang))
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4">
                ...
                <form action="{{ route('questions.duplicate-bundle') }}" method="POST"
                    onsubmit="return confirm('Duplikat seluruh bundel pertanyaan ke bidang tujuan?')">
                    @csrf
                    <div class="row g-3 align-items-end">
                        <div class="col-md-5">
                            ...
                            <select name="source_bidang" class="form-select border-primary" required>
                                ...
                                @foreach ($bundleStats->where('total', '>', 0) as $bundle)
                                    <option value="{{ $bundle['bidang'] }}">{{ $bundle['bidang'] }} ({{ $bundle['total'] }}
                                        pertanyaan)</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-primary w-100"><i
                                    class="bx bx-copy me-1"></i>Duplikat</button>
                        </div>
                    </div>
                    <div class="form-text mt-2">Pertanyaan yang identik di bidang tujuan akan dilewati sehingga tidak
                        terjadi duplikasi ganda.</div>
                </form>
            </div>
        </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <span class="avatar-initial rounded bg-label-primary p-3"><i
                                        class="bx bx-folder-open fs-4"></i></span>
                                <span
                                    class="badge {{ $bundle['total'] > 0 ? 'bg-label-success' : 'bg-label-secondary' }}">{{ $bundle['total'] }}
                                    pertanyaan</span>
                            </div>
                            ...
                            <a href="{{ route('questions.index', ['bidang' => $bundle['bidang']]) }}"
    ...
    @else
        @if ($isSuperadmin)
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                ...
                <a href="{{ route('questions.index') }}" class="btn btn-outline-secondary"><i
                        class="bx bx-arrow-back me-1"></i>Kembali ke Daftar Bidang</a>
            </div>
        @endif
            ...
            <div class="card-body">
                <form action="{{ route('questions.store') }}" method="POST">
                            ...
                            <div class="options-container">
                                <div class="input-group mb-2">
                                    ...
                                    <button class="btn btn-outline-primary" type="button"
                                        onclick="addOptionField('create-options-wrapper')"><i
                    ...
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-success" style="width: 220px; white-space: nowrap;" data-bs-toggle="modal"
                            data-bs-target="#modalImportSoal">
                            <i class="bx bx-file me-1"></i> Import Soal
                        </button>
                        <button type="submit" class="btn btn-primary w-100 shadow"><i class="bx bx-save me-1"></i>
                            Simpan Pertanyaan Evaluasi</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <form action="{{ route('questions.import') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info py-2 shadow-none mb-3">
                            ...
                            <ul class="small mb-0 ps-3">
                                ...
                                <li>CPNS, PKP, PKA, dan PKN hanya digunakan pada Bidang Pengembangan Kompetensi Manajerial.
                                </li>
                                ...
                                <li><strong>pilihan_jawaban</strong>: Isi jika tipe dropdown/checkbox (pisahkan dengan
                                    koma).</li>
                            </ul>
                        </div>
                    ...
                    <div class="modal-footer border-top">
                        <a href="{{ route('questions.template', ['bidang' => $selectedBidang]) }}"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <form action="" method="POST" id="duplicateQuestionForm" class="modal-content">
                        ...
                        <div class="modal-footer border-top">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="bx bx-copy me-1"></i>Duplikat
                                Sekarang</button>
                        </div>
                    </form>
                </div>
