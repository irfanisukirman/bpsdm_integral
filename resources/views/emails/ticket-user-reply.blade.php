...
<head>
    ...
    <title>Balasan Baru Pengguna</title>
    <style>
        ...
        .reply-box{background:#f8f9ff;border-left:4px solid #ffab00;border-radius:0 8px 8px 0;padding:16px;margin:16px 0;}
...
<body>
    <div class="wrap">
        <div class="header">
            ...
            <p>Pengguna membalas tiket yang Anda tangani</p>
        </div>
        <div class="body">
            <p>Halo,</p>
            <p>Pengguna <strong>{{ $ticket->submitter_name }}</strong> mengirim balasan baru pada tiket:</p>
            <div class="ticket-box">
                <div class="label">Nomor Tiket</div>
                <div class="number">{{ $ticket->ticket_number }}</div>
            </div>
            <p><strong>Pesan pengguna:</strong></p>
            <div class="reply-box" style="white-space:pre-wrap;">{{ $reply->message }}</div>
            <p>Silakan buka tiket untuk melanjutkan penanganan:</p>
            <p style="text-align:center;margin:24px 0;">
                <a class="btn" href="{{ route('ticketing.show',$ticket->id) }}">Buka Tiket</a>
            </p>
        </div>
        <div class="footer">
