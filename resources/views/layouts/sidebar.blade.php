<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">SIM-PEL</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Kelola Pelatihan</span>
        </li>
        ...
        <!-- MONITORING & EVALUASI -->
        @php
            // Hitung jumlah tindak lanjut yang belum selesai (Open)
        ...
        <li class="menu-item {{ request()->is('*monitoring*') ? 'active' : '' }}">
            <a href="{{ route('monitoring.index') }}" class="menu-link">
                ...
                <div>Monitoring Penyelenggaraan</div>
            </a>
        </li>

        <!-- Dropdown Kirkpatrick -->
        <li class="menu-item {{ request()->is('*evaluasi-*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->is('*evaluasi/l1*') ? 'active' : '' }}">
                    <a href="{{ route('evaluasi.l1') }}" class="menu-link">
                        <div>Level 1: Reaksi (Kepuasan)</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('*evaluasi/l2*') ? 'active' : '' }}">
                    <a href="{{ route('evaluasi.l2') }}" class="menu-link">
                        <div>Level 2: Learning (Pre/Post)</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('*evaluasi/l34*') ? 'active' : '' }}">
                    <a href="{{ route('evaluasi.l34') }}" class="menu-link">
                        <div>Level 3 & 4: Dampak (360°)</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item {{ request()->is('users*') ? 'active' : '' }}">
            <a href="{{ route('users.index') }}" class="menu-link">
                ...
                <div data-i18n="Users">Kelola User PIC</div>
            </a>
        </li>
        @endif
